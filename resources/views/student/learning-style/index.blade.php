...
@section('content')
	...
	<div ng-controller="LearningStyleController as learning_style" ng-cloak>
		...
		<test-directive ng-cloak class="hide">
			<div class="panel panel-brand panel-test" id="cari_panel">
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-xs-3">
							<button type="button" id="btn_previous" class="btn btn-brand ng-hide" ng-click="previous()" ng-show="session.reversible"><i class="fa fa-chevron-left"></i> <span ng-bind="session.previous">Previous</span></button>
						</div>
