            ...
            <content class="form-content">
                {!! Form::open(
                    ...
                    <fieldset>
                        ...
                        <div class="list-container">
                            ...
                            <ul class="list-content">
                                ...
                                <li>
                                    Impersonate any person or entity, including, but not limited to, a KCGA official, or host, or falsely state or otherwise misrepresent your affiliation with a person or entity;
                                </li>
                                <li>
                                    Forge headers or otherwise manipulate identifiers in order to disguise the origin of any Content transmitted through Futureed;
                                </li>
                                <li>
                                ...
                                <li>
                                    Upload, post, email, transmit or otherwise make available any material that contains software viruses or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of any part of Futureed;
                                </li>
                                <li>
                                ...
                                <li>
                                    Provide material support or resources (or to conceal or disguise the nature, location, source, or ownership of material support or resources) to any organization(s) designated by Singapore, your country or the United States government as a foreign terrorist organization;
                                </li>
                                <li>
                                    "stalk" or otherwise harass another;
                                </li>
                                <li>
                                    Commit any fraudulent or unlawful act, whether in relation to any third party provider of products and services on the Service or otherwise and/or
                                </li>
                                <li>
                                    Collect or store personal data about other users in connection with the prohibited conduct and activities set forth in this agreement;
                                </li>
                                <li>
                                    Create, display, transmit, or obtain materials that poses a threat to or adversely affects the national security of Singapore
                                </li>
                                <li>
                                    Create, display, transmit, or obtain materials that poses a threat to or adversely affects racial harmony in Singapore;
                                </li>
                                <li>
                    ...
                    <fieldset>
                        ...
                        <div>
                            KCGA reserves the right to suspend or terminate your use of the web site and the services at any time, without notice, if you are found in violation of our terms in this agreement.
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div>
                            The validity, construction, enforcement and interpretation of these Terms and Conditions of Use is to be governed the laws of Singapore.
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div>
                            KCGA’s failure to enforce strict performance of any provision of these Terms does not constitute a waiver of the right to subsequently enforce such provision.
                        </div>
                    </fieldset>
