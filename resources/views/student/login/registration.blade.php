            ...
            <div class="form-content col-md-12" id="form_registration">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {!! Form::select('level', array('male' => 'Male', 'female' => 'Female'), 'male',array('class' => 'form-control')); !!}
                        </div>
                    </div>  
                    <div class="form-group">
                ...
                <fieldset>
                    ...
                    <div class="form-group" id="form_address">
                        ...
                        <div class="col-md-4">
                        {!! Form::select('level', array('K2' => 'K2', 'Grade 1' => 'Grade 1', 'Grade 2' => 'Grade 2', 'Grade 3' => 'Grade 3', 'Grade 4' => 'Grade 4', 'Grade 5' => 'Grade 5', 'Grade 6' => 'Grade 6', 'Grade 7' => 'Grade 7', 'Grade 8' => 'Grade 8'), 'K2',array('class' => 'form-control')); !!}
