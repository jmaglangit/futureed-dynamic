<div class="col-xs-10 col-xs-offset-1 margin-top-15" ng-if="help.active_add">
	...
	<div class="col-xs-12 btn-container">
        ...
        {!! Form::button('Back'
            , array(
              ...
              , 'ng-click' => 'help.setCurrentActive(); help.toggleBtnHelp()'
            )
        ) !!}
	</div>
</div>