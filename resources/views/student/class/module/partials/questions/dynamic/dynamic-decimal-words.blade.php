<div>
    ...
    <div id="questionPane" class="answer_area">
        <!-- questions area -->
        <div id="start_div">
            {{--<p class="col-xs-6 h4">Rewrite the following number into words. <label id="str_interger_b"></label> + <label id="str_decimal_b"></label></p><br>--}}
    ...
    {!! Html::script('/js/common/operations/decimal_words.js'. '?size=' . File::size(public_path('/js/common/operations/decimal_words.js')))!!}
