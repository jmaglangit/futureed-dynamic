<div>
    ...
    <div id="message_modal_dynamic" class="modal">
        <div class="modal-content modal-dialog modal-lg">
            ...
            <div class="modal-footer">
                ...
                <button id="ok_simplify_modal" type="button" class="btn btn-gold btn-medium pull-right" onclick="btnOkSimplifyRetry();" style="display: none;">OK</button>
                <button id="ok_whole_num_modal" type="button" class="btn btn-gold btn-medium pull-right" onclick="btnOkWholeNumRetry();" style="display: none;">OK</button>
    ...
    {!! Html::style('/css/futureed-student.css' . '?size=' . File::size(public_path('/css/futureed-student.css'))) !!}
    {!! Html::script('/js/common/operations/fraction_division.js' . '?size=' . File::size(public_path('/js/common/operations/fraction_division.js')))!!}
