<div>
    ...
    <div>
        ...
        <div id="questionPane" class="col-xs-6 answer_area">
            <div id="start_div" class="m-top-20 h4" style="display: none;">
                ...
                {{-- <p><label><b id="digits_b"></b> in this integer
                <b id="randomNumber_b"></b></label>?</p>
    ...
    {!! Html::script('/js/common/operations/integer_identify.js' . '?size=' . File::size(public_path('/js/common/operations/integer_identify.js')))!!}
</div>