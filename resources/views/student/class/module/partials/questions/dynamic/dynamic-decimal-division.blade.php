<div>
    <div style="visibility:hidden">
        ...
        <input type="text" name="randomDigits2" id="randomDigits2" required autofocus value="2">
    ...
    <div id="examPane" style="display: none;">
        <!-- questions area -->
        <div id="questionPane">
            {{--<p class="col-xs-6 h3">Division <label id="subject_number1_p"></label> + <label id="subject_number2_p"></label></p><br>--}}
