<div>
	...
	{!! Html::script('/js/common/operations/fraction_addition_butterfly.js' . '?size=' . File::size(public_path('/js/common/operations/fraction_addition_butterfly.js')))!!}
