<div>
    ...
    <div>
        ...
        <div id="answerPane" class="col-xs-6 pull-right h4 sort_small_ans">
            <div id="lastDiv1"></div>
        ...
        <!-- done answering -->
        <div id="tipsFlow" class="tips_small_adjst" style="display: none;">
    ...
    {!! Html::script('/js/common/operations/sort_min.js?20170806'  . '?size=' . File::size(public_path('/js/common/operations/sort_min.js')))!!}
</div>