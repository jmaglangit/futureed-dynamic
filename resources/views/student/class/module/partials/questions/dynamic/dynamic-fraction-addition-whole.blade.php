<div>
        ...
        <div class="modal-content modal-dialog modal-lg">
            ...
            <div class="modal-footer">
                ...
                <button id="no_whole_modal" type="button" class="btn btn-gold btn-medium pull-right" onclick="wholebtnNOOnclick();">
                    {!! trans('messages.no') !!}</button>
                <button id="yes_combine_modal" type="button" class="btn btn-green btn-medium pull-left" data-dismiss="modal" onclick="combinebtnYEsOnclick();">
                    {!! trans('messages.yes') !!}</button>
    ...
    {!! Html::script('/js/common/operations/fraction_addition_whole.js' . '?size=' . File::size(public_path('/js/common/operations/fraction_addition_whole.js')))!!}
