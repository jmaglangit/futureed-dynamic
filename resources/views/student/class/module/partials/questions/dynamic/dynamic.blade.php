...
<div ng-if="mod.current_question.question_template.operation == futureed.FRACTION_ADDITION_WHOLE">
    <div template-directive template-url="{!! route('student.class.module.partials.questions.dynamic.fraction-addition-whole') !!}"></div>
</div>
...
<div ng-if="mod.current_question.question_template.operation == futureed.INTEGER_CONVERT_NUMBER">
    <div template-directive template-url="{!! route('student.class.module.partials.questions.dynamic.integer-convert-number') !!}"></div>
</div>
...
<div ng-if="mod.current_question.question_template.operation == futureed.INTEGER_IDENTIFY">
    <div template-directive template-url="{!! route('student.class.module.partials.questions.dynamic.integer-identify') !!}"></div>
</div>
...
<div ng-if="mod.current_question.question_template.operation == futureed.DECIMAL_NUMERIC">
    <div template-directive template-url="{!! route('student.class.module.partials.questions.dynamic.decimal-numeric') !!}"></div>
</div>
...
<div ng-if="mod.current_question.question_template.operation == futureed.DECIMAL_RATIONAL_NUMBER">
    <div template-directive template-url="{!! route('student.class.module.partials.questions.dynamic.decimal-rational-number') !!}"></div>
</div>
<div ng-if="mod.current_question.question_template.operation == futureed.EXPONENT">
    <div template-directive template-url="{!! route('student.class.module.partials.questions.dynamic.exponent') !!}"></div>
</div>