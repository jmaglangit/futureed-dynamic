	...
	<div class="col-xs-12">
		<div class="class-search">
			...
			<div class="form-group">
				...
				<div class="col-xs-3" ng-init="getGradeLevel(user.user.curriculum_country)">
	...
	<div class="col-xs-12 class-container">
		<ul class="nav nav-pills module-pills" role="tablist">
			<li role="presentation" class="module-tabs" ng-repeat="aClass in class.classes track by $index" ng-class="{ 'active' : aClass.class_id == class.current_class }"
				...
				<a href="#home" aria-controls="home" role="tab" data-toggle="tab" class="font-size-16">{! aClass.classroom.subject.name !}</a>
			</li>
			<li role="presentation" class="module-tabs" ng-class="{ 'active' : aClass.class_id == class.current_class }">
				<a href="{!! route('student.reports.index') !!}" class="font-size-16">{!! trans('messages.reports') !!}</a>
			</li>
		</ul>
			...
			<div class="tab-pane active">
				<div class="list-container" ng-cloak>
					...
					<div class="module-list row" ng-if="class.records.length">
						<div class="col-md-1">
							<img ng-if="class.grade_name == ''" class="curriculum-button-disabled" ng-src="/images/curriculum-button.png" tooltip="{!! trans('messages.curriculum_pdf_message_disabled') !!}"
								tooltip-placement="bottom" tooltip-class="module-tooltip"/>
							<img ng-if="class.grade_name != ''" class="curriculum-button" ng-src="/images/curriculum-button.png" tooltip="{! class.grade_name + '' !} {!! trans('messages.curriculum_pdf') !!}"
