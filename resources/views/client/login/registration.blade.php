...
@section('content')
	<div class="container" ng-controller="LoginController as register" 
		ng-init="register.setActive('registration')" ng-cloak>
		<div template-directive template-url="{!! route('client.partials.base_url') !!}"></div>

		<div class="form-style registration-container form-wide" ng-show="register.active_registration"> 
			<div class="title">Register Account as</div>
		
			<div class="row">
				<div class="col-xs-12">
					<div class="col-xs-3"></div>
					<div class="col-xs-3" ng-click="register.selectRole('Principal')">
				...
				<div class="col-xs-12" ng-if="register.record.client_role">
					<div class="alert alert-error" ng-if="register.errors">
						<p ng-repeat="error in register.errors track by $index"> 
							{! error !}
						</p>
					</div>
