<div class="progress-container">
	<h3 ng-if="reports.student.student_name">{! reports.student.student_name!} {!! trans('messages.client_progress_curriculum') !!}</h3>
	<h3 ng-if="reports.student.first_name">{! reports.student.first_name!} {! reports.student.last_name!} {!! trans('messages.client_progress_curriculum') !!}</h3>
	<div class="row">
