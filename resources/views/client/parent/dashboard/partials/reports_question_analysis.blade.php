            ...
            <tbody>
                <tr ng-repeat="question in reports.question_analysis">
                    ...
                    <td class="col-md-3 text-left">
                        <img class="question-tip-image" err-src-directive ng-if="question.image != futureed.EMPTY_STR" ng-src="{!! config('futureed.answer_explanation_image_public') !!}/{! question.image !}">
