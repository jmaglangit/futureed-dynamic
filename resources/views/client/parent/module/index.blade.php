...
@section('scripts')
	{!! Html::script('/js/client/controllers/manage_parent_module_controller.js' . '?size=' . File::size(public_path('/js/client/controllers/manage_parent_module_controller.js')))!!}
	{!! Html::script('/js/client/services/manage_parent_module_service.js' . '?size=' . File::size(public_path('/js/client/services/manage_parent_module_service.js')))!!}
