...
@section('scripts')
	{!! Html::script('/js/client/controllers/manage_teacher_student_controller.js' . '?size=' . File::size(public_path('/js/client/controllers/manage_teacher_student_controller.js')))!!}
	{!! Html::script('/js/client/services/manage_teacher_student_service.js' . '?size=' . File::size(public_path('/js/client/services/manage_teacher_student_service.js')))!!}
