<div ng-if="user.role == futureed.TEACHER" ng-controller="ManageTeacherContentController as dashboard" ng-init="dashboard.setActive(futureed.DASHBOARD)" ng-cloak>
	<div ng-if="!dashboard.active_report" class="dashboard-content">
		<p>{!! trans('messages.client_teacher_dashboard_msg1') !!}
		<a href="{!! route('client.teacher.class.index') !!}"> {!! trans('messages.class') !!}</a>.</p>

		<p>{!! trans('messages.client_teacher_dashboard_msg2') !!}
		<a href="{!! route('client.teacher.student.index') !!}"> {!! trans('messages.student') !!}</a>.</p>

		<p>{!! trans('messages.client_teacher_dashboard_msg3') !!}
		<a href="{!! route('client.teacher.module.index') !!}"> {!! trans('messages.module') !!}</a>.</p>
	</div>
