{!! Form::open(array('id' => 'client_profile_form', 'class' => 'form-horizontal', 'ng-if' => 'profile.active_index || profile.active_edit')) !!}
	<fieldset>
		...
		<div class="form-group">
			<label for="" class="col-xs-3 control-label">Username <span class="required">*</span></label>
			<div class="col-xs-5">
				{!! Form::text('username', ''
					, array(
						'class' => 'form-control'
		...
		<div class="form-group">
			<label for="" class="col-xs-3 control-label">Email <span class="required">*</span></label>
			<div class="col-xs-5">
		...
		<div class="form-group" ng-if='profile.prof.new_email'>
			<label for="" class="col-xs-3 control-label" style="color:#7F7504">Pending Email <span class="required">*</span></label>
			<div class="col-xs-5">
				{!! Form::text('email', ''
					, array(
						'class' => 'form-control'
	...
	<fieldset>
		...
		<div class="form-group">
				<label for="" class="col-xs-3 control-label">First Name <span class="required">*</span></label>
				<div class="col-xs-5">
			...
			<div class="form-group">
				<label for="" class="col-xs-3 control-label">Last Name <span class="required">*</span></label>
				<div class="col-xs-5">
					{!! Form::text('last_name', ''
						, array(
							'class' => 'form-control'
	...
	<fieldset ng-if="profile.is_teacher">
		...
		<div class="form-group">
			<label for="" class="col-xs-3 control-label">School Name <span class="required">*</span></label>
			<div class="col-xs-5">
	...
	<fieldset ng-if="profile.is_principal">
		...
		<div class="form-group">
			<label for="" class="col-xs-3 control-label">Street Address <span class="required">*</span></label>
			<div class="col-xs-5">
		...
		<div class="form-group">
			...
			<label for="" class="col-xs-3 control-label">State <span class="required">*</span></label>
			<div class="col-xs-3">
		...
		<div class="form-group" ng-init="getCountries()">
			<label for="" class="col-xs-3 control-label">Postal Code</label>
			<div class="col-xs-3">
			...
			<label for="" class="col-xs-3 control-label">Country <span class="required">*</span></label>
			<div class="col-xs-3">
		...
		<div class="form-group">
			<label class="col-xs-3 control-label">Contact Person <span class="required">*</span></label>
			<div class="col-xs-6">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<label for="" class="col-xs-3 control-label">State </label>
			<div class="col-xs-3">
				{!! Form::text('state', ''
					, array(
						'class' => 'form-control'
