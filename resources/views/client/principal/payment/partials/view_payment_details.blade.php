    ...
    <div class="form-content col-xs-12" ng-init="payment.getSchoolCode()">
        <div ng-if="payment.invoice.payment_status == futureed.PENDING">
            <fieldset class="payment-field">
                ...
                <p class="step-label">Please select a subject.</p>
            ...
            <fieldset class="payment-field">
                ...
                <div class="col-xs-12">
                    <div class="form-search">
                        <div class="form-group">
                            <label class="col-xs-3 control-label" id="email">Number of Seats <span
                        ...
                        <div class="form-group" ng-init="getGradeLevel(user.country_id)">
                            ...
                            <div class="col-xs-5">
                                <select name="grade_id" ng-disabled="!grades.length || payment.invoice.renew"
                                    ...
                                    <option ng-selected="payment.classroom.grade_id == futureed.false" value="">--
                                        Select Level --
                                    </option>
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 control-label" id="email">Teacher <span
                                        class="required">*</span></label>
