		...
		<div class="form-content col-xs-12">
	        ...
	        <fieldset>
	        	...
	        	<div class="form-group">
	        		...
	        		<div class="col-xs-5" ng-init="client.setClientRole()">
	        			{!! Form::select('role', 
	        				[	'' => '-- Select Role --',
	            				'Principal' => 'Principal', 
	            				'Teacher' => 'Teacher', 
	        ...
	        <fieldset ng-if="client.create.teacher">
	        	<legend class="legend-name-mid">
	        		School Information
	        	</legend>
	        	<div class="form-group">
	        ...
	        <fieldset ng-if="client.create.principal">
	        	<legend class="legend-name-mid">
	        		School Information
	        	</legend>
	        	<div class="form-group">
	        		...
	        		<div class="col-xs-4">
	        			{!! Form::text('school_postal',''
	        				, array(
	        					...
	        					, 'ng-model' => 'client.create.school_postal'
	        					, 'class' => 'form-control'
	        				)
	        			) !!}
	        		</div>
	        		...
	        		<div class="col-xs-4">
	        			{!! Form::text('contact_person',''
	        				, array(
	        					...
	        					, 'ng-model' => 'client.create.contact_person'
	        					, 'class' => 'form-control'
	        				)
	        			) !!}
	        		</div>
	        ...
	        <fieldset>
	        	...
	        	<legend class="legend-name-mid" ng-if="cliente.create.parent">
	        		Address Information
	        	</legend>
	        	<div class="form-group">
	        		<label class="col-xs-2 control-label" id="school_name">School Name</label>
