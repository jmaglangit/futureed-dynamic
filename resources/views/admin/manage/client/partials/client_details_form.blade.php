	        	...
	        	<div class="form-group">
	        		...
	        		<label class="col-md-2 control-label">Country <span class="required">*</span></label>
				      <div class="col-md-4" ng-init="getCountries()">
				        <select  name="school_country_id" class="form-control" ng-disabled="client.active_view_client" ng-model="client.details.school_country_id">
	        ...
	        <fieldset ng-if="client.details.client_role">
	        	...
	        	<div class="form-group">
	        		...
	        		<label class="col-md-2 control-label">Country <span class="required" ng-if="client.role.parent">*</span></label>
				      <div class="col-md-4" ng-init="getCountries()">
				        <select  name="country_id" class="form-control" ng-disabled="client.active_view_client" ng-model="client.details.country_id">
				          <option ng-selected="true" value="">-- Select Country --</option>
