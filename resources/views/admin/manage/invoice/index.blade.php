...
@section('content')
	<div class="container dshbrd-con" ng-controller="ManageInvoiceController as invoice" ng-cloak>
		...
		<div class="wrapr" ng-init="invoice.setActive()">
...
@section('scripts')
	{!! Html::script('/js/admin/controllers/manage_invoice_controller.js' . '?size=' . File::size(public_path('/js/admin/controllers/manage_invoice_controller.js')))!!}
	{!! Html::script('/js/admin/services/manage_invoice_service.js' . '?size=' . File::size(public_path('/js/admin/services/manage_invoice_service.js')))!!}
@stop