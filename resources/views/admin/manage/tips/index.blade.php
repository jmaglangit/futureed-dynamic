...
@section('scripts')
	{!! Html::script('/js/admin/controllers/manage_tips_controller.js'. '?size=' . File::size(public_path('/js/admin/controllers/manage_tips_controller.js')))!!}
	{!! Html::script('/js/admin/services/manage_tips_service.js'. '?size=' . File::size(public_path('/js/admin/services/manage_tips_service.js')))!!}
@stop