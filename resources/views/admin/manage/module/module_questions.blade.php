...
@section('content')
    <div id="module" class="container dshbrd-con-question-view" ng-controller="ManageModuleQuestionController as question"
...
@section('scripts')
    {!! Html::script('/js/admin/controllers/manage_module_question_controller.js' . '?size=' . File::size(public_path('/js/admin/controllers/manage_module_question_controller.js')))!!}
    {!! Html::script('/js/admin/services/manage_module_question_service.js' . '?size=' . File::size(public_path('/js/admin/services/manage_module_question_service.js')))!!}
