			...
			<div class="client-content">
				...
				<ul class="nav nav-pills nav-admin">
					<li ng-class="{ 'active' : sale.active_price_settings }">
						<a ng-click="sale.setActive('price_settings')" href="javascript:void(0)"><span><i class="fa fa-dollar"></i>{!! ucfirst(trans('messages.admin_price_settings')) !!}</span></a></li>
					<li ng-class="{ 'active' : sale.active_client_discount }">
						<a ng-click="sale.setActive('client_discount')" href="javascript:void(0)"><span><i class="fa fa-tags"></i>{!! ucfirst(trans('messages.admin_client_discount')) !!}</span></a></li>
					<li ng-class="{ 'active' : sale.active_bulk_settings }">
						<a ng-click="sale.setActive('bulk_settings')" href="javascript:void(0)"><span><i class="fa fa-database"></i>{!! ucfirst(trans('messages.admin_bulk_settings')) !!}</span></a></li>
				</ul>
