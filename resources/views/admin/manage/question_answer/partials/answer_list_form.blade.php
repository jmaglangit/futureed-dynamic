		...
		{!! Form::open(array('class' => 'form-horizontal')) !!}
			<div class="form-search">
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						<div class="btn btn-blue" ngf-select ngf-change="qa.uploadAnswer($files, qa.answers.record)"> Choose Image... </div>
					</div>
				...
				<div class="form-group" ng-if="qa.answers.record.uploaded">
					...
					<div class="col-xs-5">
						...
						<a href="" class="control-label col-xs-6" ng-click="qa.viewAnswerImage(qa.answers.record)">View Image</a>
					</div>
				</div>

				<div class="form-group" ng-if="qa.active_view && qa.answers.record.original_image_name && qa.answers.record.original_image_name != '0'">
				...
				<tbody>
					<tr ng-repeat="record in qa.answers.records">
						...
						<td ng-if="qa.answers.records.length">
							<div class="row">
								<div class="col-xs-6">
									<a href="" ng-click="qa.setAnsActive(futureed.ACTIVE_EDIT, record.id)"><span><i class="fa fa-pencil"></i></span></a>
								</div>
								<div class="col-xs-6">
									<a href="" ng-click="qa.confirmAnsDelete(record.id)"><span><i class="fa fa-trash"></i></span></a>
								</div>
							</div>
						</td>
					</tr>
