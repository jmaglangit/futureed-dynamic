<div ng-if="grade.active_add">
	<div class="content-title">
		<div class="title-main-content">
			<span>{!! trans('messages.admin_add_grade') !!}</span>
		</div>
	</div>
			...
			<fieldset>
				<div class="form-group">
					...
					<div class="col-xs-5">
						{!! Form::text('code',''
							, array(
								'placeHolder' => trans('messages.admin_grade_code')
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						{!! Form::text('name',''
							, array(
								'placeHolder' => trans('messages.admin_grade_name')
				...
				<div class="form-group">
					<label class="col-md-3 control-label">{!! trans('messages.country') !!} <span class="required">*</span></label>
