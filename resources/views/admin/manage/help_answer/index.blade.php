...
@section('scripts')
	{!! Html::script('/js/admin/controllers/manage_help_answer_controller.js' . '?size=' . File::size(public_path('/js/admin/controllers/manage_help_answer_controller.js')))!!}
	{!! Html::script('/js/admin/services/manage_help_answer_service.js' . '?size=' . File::size(public_path('/js/admin/services/manage_help_answer_service.js')))!!}
@stop