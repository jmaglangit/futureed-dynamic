				...
				switch ($this->method()) {
					case 'PUT':
						...
						if ($role === config('futureed.principal')) {
							...
							$specific_role_validations = array_merge($specific_role_validations, $principal_validations, $common_principal_validations, $this->common_parent_principal_validation());
						}
