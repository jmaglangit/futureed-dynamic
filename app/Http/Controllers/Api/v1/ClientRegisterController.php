	...
	public function register(){
        ...
        // cannot be use for teacher registration
            ...
            if(strtolower($client['client_role']) == strtolower(config('futureed.parent'))){
                ...
                $this->addMessageBag($this->validateAlphaDash($client,'city'));
                $this->addMessageBag($this->validateAlphaDash($client,'state'));
                ...
                $this->addMessageBag($this->validateAlphaDash($school,'school_state'));
                ...
                $this->addMessageBag($this->validateAlphaDashOptional($client,'city'));
                $this->addMessageBag($this->validateAlphaDashOptional($client,'state'));
