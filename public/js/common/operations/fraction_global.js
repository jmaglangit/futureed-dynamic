    ...
    function validateAnswer(_elem, _correct_answer) {
        // console.log("211111111333333333333");
    	...
    	if((_answer * 1 < _start_num) || (_answer * 1 > _end_num))	{
            return _errorHandler(_elem, -2, "Answer can't less than " + _start_num + " or more than " + _end_num + " !");
        }

    	if(_answer < _correct_answer) {
            if (!correctAnswer_temp) {
                console.log("correctAnswer_temp = " + $(this).prop("value"));
                console.log("correctAnswer_temp = " + correctAnswer_temp);
                correctAnswer_temp = _answer;
            }
    ...
    function validateAnswer4Substraction(_elem, _correct_answer) {
    	...
    	// console.log("Correct Answer:11111111111 " + _correct_answer + ", Answered Answer: " + _elem.prop("value"));
