...
function btncalculateOnclick(){
    ...
    if (step_count == 1) {
        result_str = "<div>";
        result_str += "<p>Step " + step_count +": Cross multiple #1 </p>";
        result_str += '<div>';
        ...
        result_str += '<div>';
            result_str += '<table>';
                result_str += '<tr>';
                    ...
                    result_str += '<td align="center"><label style = "color:blue">'+ z1 +'</label></td>';
                    result_str += '<td align="center" valign="middle"><b> X </b></td>';
...
function nextsetp(){
    ...
    if (step_count == 3) {
        ...
        result_str += '<div>';
            result_str += '<table>';
                result_str += '<tr>';
                    ...
                    result_str += '<td align="center" valign="middle"><b> - </b></td>';
        ...
        result_str += '</div>';
        result_str += "</div>";
        $("#Subtractiononeandtwo").html(result_str);
    }

    if (step_count == 4) {
        result_str = "<div>";
        result_str += "<p>Step " + step_count +": Multiply denominators </p>";
        result_str += '<div>';
            result_str += '<table>';
                result_str += '<tr>';
...
function wholebtnNOOnclick() {
    // alert("Can not! Retry!");
     retryWholeNumModal("hat is incorrect. Fraction can be simplified. Please retry.");
    // wholeBtnFlag = false;
    // nextsetp();
    // $(".inputCheck2").show();
    // $(".inputCheck3").show();
...
function btnNOOnclick(){
    // alert("Can not!Retry!");
    retrySimplifyModal("hat is incorrect. Fraction can be simplified. Please retry.");
}
...
function displayTotalFlow(){
    ...
    strhtml += '<div id="examPane1" style="">';
        strhtml += '<table>';
            ...
            strhtml += '<tr>';
            strhtml += '<td colspan="5"><b>Subtraction:</b></td>';
