...
IDE_Morph.prototype.setDefaultDesign = function () {
    ...
    StageMorph.prototype.paletteColor = new Color(0, 0, 0);
    SpriteMorph.prototype.sliderColor = new Color(220, 220, 220);

    IDE_Morph.prototype.buttonContrast = 35;
...
IDE_Morph.prototype.createControlBar = function () {
    ...
    //this.controlBar.color = new Color(255, 150, 100);
    //this.controlBar.setHeight(this.logo.height()); // height is fixed
    /* Removed mouseClickLeft*/
    //this.controlBar.mouseClickLeft = function () {
    //    this.world().fillPage();
    //};
    //this.add(this.controlBar);

    //smallStageButton || Toggles Between The Min Stage Size and the defined stage size
    ...
    //smallStageButton
    //appModeButton || Toggles the to Full Stage View and Defined Stage Size
    button = new ToggleButtonMorph(
        null, //colors,
        myself, // the IDE is the target
        'toggleAppMode',
    ...
    //appModeButton
    // stopButton || Stops Stage animation
    button = new ToggleButtonMorph(
        null, // colors
    ...
    // stopButton
    //pauseButton || Pauses Stage Animation
    button = new ToggleButtonMorph(
        null, //colors,
        this, // the IDE is the target
        'togglePauseResume',
    ...
    //pauseButton
    // startButton || Starts Stage animation
    ...
    // startButton
    // projectButton || Project Settings
    button = new PushButtonMorph(
        this,
        'projectMenu',
...
//Scripts Area vertical scrollbar
IDE_Morph.prototype.createSpriteEditor = function () {
    ...
    if (this.currentTab === 'scripts') {
        ...
        //this.add(this.spriteEditor); //latest <--- 5/25/2016
    }
};
...
IDE_Morph.prototype.fixLayout = function (situation) {
    ...
    this.palette.setTop(this.categories.bottom() - 5); //<--- this is the original 5/25/2016
    ...
    if (situation !== 'refreshPalette') {
        ...
        this.spriteBar.setExtent(new Point(
            ...
            0//this.categories.bottom() - this.spriteBar.top() - padding
        ));
...
IDE_Morph.prototype.applySavedSettings = function () {
    var design = this.getSetting('design'),
        zoom = 1.35,//this.getSetting('zoom'),
