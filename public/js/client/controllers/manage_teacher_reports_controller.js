angular.module('futureed.controllers')
    .controller('ManageTeacherReportsController', ManageTeacherReportsController);

ManageTeacherReportsController.$inject = ['$scope', '$timeout', 'ManageTeacherReportsService', 'SearchService'];

function ManageTeacherReportsController($scope, $timeout, ManageTeacherReportsService, SearchService) {
    var self = this;
    ...
    self.records = {};
    self.class_list = Constants.FALSE;
    ...
    self.reportCard = function () {
        ...
        $scope.ui_block();
        ManageTeacherReportsService.reportCard(self.student_id).success(function (response) {
    ...
    self.summaryProgress = function (subject_id) {
        ...
        $scope.ui_block();
        ManageTeacherReportsService.summaryProgress(self.student_id, self.search.subject_id).success(function (response) {
            if (angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
    ...
    self.listSubjects = function () {
        ...
        $scope.ui_block();
        ManageTeacherReportsService.listClass(self.student_id).success(function (response) {
            if (angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
    ...
    self.currentLearning = function (subject_id) {
        ...
        $scope.ui_block();
        ManageTeacherReportsService.currentLearning(self.student_id, self.search.subject_id).success(function (response) {
            if (angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
                    ...
                    self.student_report_export = '/api/report/student-progress/current-learning/' + self.student_id +'/' + self.search.subject_id;
                }
            }
    ...
    self.subjectArea = function (subject_id) {
        ...
        $scope.ui_block();
        ManageTeacherReportsService.subjectArea(self.student_id, self.search.subject_id).success(function (response) {
            if (angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
                    ...
                    self.summary.records = response.data.rows;
                    self.student = response.data.additional_information;
                    self.student_report_export = '/api/report/student-progress/curriculum/' + self.student_id +'/' + self.search.subject_id;
                }
            }
    ...
    self.subjectAreaHeatmap = function (subject_id) {
        ...
        $scope.ui_block();
        ManageTeacherReportsService.subjectAreaHeatmap(self.student_id, self.search.subject_id).success(function (response) {
            if (angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
                    ...
                    self.summary.records = response.data.rows;
                    self.student = response.data.additional_information;
                    self.student_report_export = '/api/report/student-progress/curriculum/heat-map/' + self.student_id +'/' + self.search.subject_id;
                }
            }
    ...
    self.getIAssessReportLink = function(){
        ...
        $scope.ui_block();
        ManageTeacherReportsService.getIAssessDownloadLinkReport(self.student_id).success(function (response){
            if(angular.equals(response.status, Constants.STATUS_OK)){
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
    ...
    self.getQuestionAnalysis = function(){
        ...
        //get subject class
        $scope.ui_block;
        ManageTeacherReportsService.questionAnalysis(self.question_analysis_param).success(function (response){
            if(angular.equals(response.status, Constants.STATUS_OK)){
                if(response.errors){
                    self.errors = $scope.errorHandler(response.errors);
                } else if(response.data){
    ...
    self.getStudentMonthlySpentHours = function(){
        ...
        ManageTeacherReportsService.getStudentChartMonthHours(self.student_id).success(function(response){
            if(angular.equals(response.status, Constants.STATUS_OK)){
                if(response.errors){
                    self.errors = $scope.errorHandler(response.errors);
                } else if(response.data){
    ...
    self.getStudentWeeklySpentHours = function(){
        ...
        ManageTeacherReportsService.getStudentChartWeekHours(self.student_id).success(function(response){
            if(angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
    ...
    self.getStudentChartSubjectArea = function(subject_id,grade_id){
        ...
        ManageTeacherReportsService.getStudentChartSubjectArea(data).success(function(response){
            if(angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
    ...
    self.getStudentChartSubjectAreaHeatMap = function(subject_id,grade_id){
        ...
        ManageTeacherReportsService.getStudentChartSubjectAreaHeatMap(data).success(function(response){
            if(angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
    ...
    self.getAllClass = function(){
        self.class_id = Constants.FALSE;
        ManageTeacherReportsService.getAllClass($scope.user.id).success(function(response){
            if(angular.equals(response.status, Constants.STATUS_OK)) {
                if (response.errors) {
                    self.errors = $scope.errorHandler(response.errors);
                } else if (response.data) {
