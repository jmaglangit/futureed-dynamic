...
class QuestionTableSeeder extends Seeder
{
    public function run()
    {
		...
		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_4.csv');
		...
		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_8.csv');

		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_9.csv');

		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_10.csv');

		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_11.csv');

		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_12.csv');

		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_13.csv');

		$this->command->info('Loading Question data...');
		$this->dataLoader('questions_14.csv');
